...
int main(){
    ...
    float numeromenospreciso = 9.223372036854775807; // Números decimais com menor precisão do que double. Tamanho = 64 bits.
    double numeromaispreciso = 9.223372036854775807; // Números decimais com maior precisão do que float. Tamanho = 64 bits.
    long double numeromuitopreciso = 9.223372036854775807; // Números decimais com maior precisão do que double. Tamanho = 128 bits.
    
    unsigned int numeronormalpositivo = 2147483647; // unsigned aceita apenas números positivos.
    ...
    printf("Número decimal muito preciso (double): %.21lf \n", numeromuitopreciso);
